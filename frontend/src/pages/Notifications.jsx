...
const Notifications = () => {
  ...
  return (
    <div className="h-screen w-screen flex flex-col lg:flex-row">
      <Sidebar />
      <div className="w-full h-full py-5 lg:py-10 px-5 overflow-hidden bg-gray-100 relative">
        <div className="w-full h-auto flex items-center justify-between">
          ...
          {notificationCount > 0 ? (
            <button
              ...
              className="flex items-center gap-3 bg-white px-3 py-2 lg:px-5 lg:py-3 cursor-pointer"
            >
              <img
        ...
        <div className="w-full h-auto overflow-y-scroll justify-center lg:justify-start pt-5 mt-5 flex flex-wrap gap-x-3 gap-y-3">
          {notification?.map((notif, index) => (
            <div
              key={index}
              className="w-110 md:w-100 md:h-40 bg-white flex flex-col gap-4 py-2 px-3 rounded-md lg:pt-3"
            >
              ...
              {deleteDetails.deleteScreen ? (
                <div className="w-full h-full absolute top-0 left-0 flex justify-center items-center z-8">
                  <div className="w-[80%] md:w-[60%] h-[25%] lg:w-[30%] bg-white flex flex-col items-center justify-center p-2 lg:p-5">
                    ...
                    <div className="flex w-full h-auto justify-between">
                      <button
                        ...
                        className="md:w-30 w-20 py-1 lg:px-10 rounded-md bg-gray-100 cursor-pointer"
                      >
                        No
                      </button>
                      <button
