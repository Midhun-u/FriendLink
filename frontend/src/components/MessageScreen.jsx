...
const MessageScreen = ({
  ...
  return (
    <div className="grid grid-rows-[70px_1fr_70px] lg:grid-rows-[90px_1fr_90px] w-full h-full absolute overflow-scroll lg:relative">
      <div className="w-full h-full bg-white grid grid-cols-[1fr_100px] px-2 lg:px-5 rounded-md">
        ...
        <div className="w-full h-full flex items-center justify-center gap-5 relative">
          ...
          {moreSection ? (
            <div className="w-50 h-auto absolute top-24 right-10 flex flex-col items-center bg-white rounded-md z-10">
              <div className="w-full h-12 lg:h-15 flex items-center gap-3 cursor-pointer hover:bg-gray-200 px-5">
                <img
              ...
              <div className="w-full h-12 lg:h-15 flex items-center gap-3 cursor-pointer hover:bg-gray-300 px-5">
                <img
                  className="w-7 h-7 lg:w-10 lg:h-10"
      ...
      <div className="w-full h-full bg-gray-100 flex justify-center items-center">
        <div className="w-[95%] h-[90%] rounded-md bg-white grid grid-cols-[auto_1fr_auto] content-center px-3 relative">
          {
            file
            ?
