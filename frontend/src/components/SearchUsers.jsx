    ...
    <>
      {searchUsers?.map((searchUser, index) => (
        <div
          ...
          className="w-full h-auto rounded-md min-h-25 px-5 bg-white grid grid-cols-[70px_200px_auto] lg:grid-cols-[70px_200px_auto] xl:grid-cols-[80px_200px_auto] cursor-pointer gap-4 py-3"
          key={index}
        >
